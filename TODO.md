...
### 2025-09-23
- [feat] Добавлена кнопка "Отмена" в меню настроек
  - Добавлена кнопка "Отмена" в главное меню настроек (/settings)
  - Добавлена кнопка "Отмена" в меню выбора времени напоминания
  - Добавлена кнопка "Отмена" в меню выбора языка
  - Реализован обработчик `settings:cancel` для удаления меню при нажатии на кнопку
  - Использована существующая локализация с ключом 'cancel'
- [feat] Добавлена кнопка "Настройки" в главное меню
  - Регистрация в `bot/plugins_bot/settings/settings.py` кнопки для вызова команды `/settings`
  - Добавлен пункт меню с ключом локализации `menu_settings` и иконкой шестеренки ⚙️
  - Локализации для `menu_settings` добавлены во все языки (ru, en, tt, tt_lat, ba, ba_lat)
  - Позиция в меню установлена после кнопок дневника (order: 40)
